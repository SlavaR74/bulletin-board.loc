...
<p class="text-right"><a href="<?php echo e(route('bb.add')); ?>">Добавить объявление</a></p>
<?php if(count($bbs) > 0): ?>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\work\projects\bboard\resources\views/home.blade.php ENDPATH**/ ?>